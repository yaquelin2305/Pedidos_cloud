 ...
 * Mismo mapeo que ms-pedidos360-catalog y ms-pedidos360-bff, para que "Admin"/"Operator"/
 * "Customer" signifiquen lo mismo en todos los microservicios. Si en Azure AD los roles vienen
 * en otro claim (por ejemplo "groups" en vez de app roles), ajustar ROLES_CLAIM aqui.
 */
